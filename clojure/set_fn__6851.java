...
public final class set_fn__6851 extends clojure.lang.AFunction {
 ...
 static {
  ...
  const__4 = (clojure.lang.Symbol)((clojure.lang.IObj)Symbol.intern(null, "clojure.set")).withMeta((IPersistentMap)RT.map(Keyword.intern(null, "author"), "Rich Hickey", Keyword.intern(null, "doc"), "Set operations such as union/intersection."));
 }
 public set_fn__6851() {
  super();
 }
