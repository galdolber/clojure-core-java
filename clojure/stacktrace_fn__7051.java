...
public final class stacktrace_fn__7051 extends clojure.lang.AFunction {
 ...
 static {
  ...
  const__4 = (clojure.lang.Symbol)((clojure.lang.IObj)Symbol.intern(null, "clojure.stacktrace")).withMeta((IPersistentMap)RT.map(Keyword.intern(null, "author"), "Stuart Sierra", Keyword.intern(null, "doc"), "Print stack traces oriented towards Clojure, not Java."));
 }
 public stacktrace_fn__7051() {
  super();
 }
