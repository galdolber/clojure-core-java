...
public final class pprint_pprint_simple_list extends clojure.lang.AFunction {
 ...
 public pprint_pprint_simple_list() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object alis1) {
  try {
   Object __r5909 = ((IFn)const__0).invoke();
   if (__r5909 != null && !(__r5909 == Boolean.FALSE)) {
    ...
    ((IFn)new clojure.pprint_pprint_simple_list_fn__8224(alis1)).invoke();
   }
   return null;
