...
public final class core_ns_interns extends clojure.lang.AFunction {
 ...
 public core_ns_interns() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object ns1) {
  {
   Object ns2 = ((IFn)const__0.getRawRoot()).invoke(ns1);
   return ((IFn)const__1.getRawRoot()).invoke(const__2.getRawRoot(), new clojure.core_ns_interns_fn__4522(ns2), ((IFn)const__3.getRawRoot()).invoke(ns2));
  }
 }
}
