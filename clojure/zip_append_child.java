...
public final class zip_append_child extends clojure.lang.AFunction {
 ...
 public zip_append_child() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object loc1, java.lang.Object item2) {
  return ((IFn)const__0.getRawRoot()).invoke(loc1, ((IFn)const__1.getRawRoot()).invoke(loc1, ((IFn)const__2.getRawRoot()).invoke(loc1), ((IFn)const__3.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke(loc1), RT.vector(item2))));
 }
}
