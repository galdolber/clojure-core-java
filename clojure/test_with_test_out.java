...
public final class test_with_test_out extends clojure.lang.RestFn {
 ...
 static {
  ...
  const__6 = (clojure.lang.Symbol)Symbol.intern("clojure.core", "*out*");
  const__7 = (clojure.lang.Symbol)Symbol.intern("clojure.test", "*test-out*");
 }
 public test_with_test_out() {
  super();
 }
