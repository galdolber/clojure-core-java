...
public final class protocols_fn__6109 extends clojure.lang.AFunction {
 ...
 public protocols_fn__6109() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object a_seq1, java.lang.Object f2, java.lang.Object val3) {
  {
   Object arr4 = ((boolean[])((clojure.lang.ArraySeq.ArraySeq_boolean)a_seq1).array);
   {
    long i5 = clojure.lang.RT.longCast((int)((clojure.lang.ArraySeq.ArraySeq_boolean)a_seq1).index());
    Object val6 = val3;
    while(true) {
     if (clojure.lang.Numbers.lt((long)i5, (long)clojure.lang.RT.alength((boolean[])((boolean[])arr4)))) {
      {
       Object ret7 = ((IFn)f2).invoke(val6, (clojure.lang.RT.aget((boolean[])((boolean[])arr4), (int)clojure.lang.RT.intCast((long)i5)) ? Boolean.TRUE : Boolean.FALSE));
