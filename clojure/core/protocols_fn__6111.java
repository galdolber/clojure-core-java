...
public final class protocols_fn__6111 extends clojure.lang.AFunction {
 ...
 public protocols_fn__6111() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object a_seq1, java.lang.Object f2, java.lang.Object val3) {
  {
   Object arr4 = ((char[])((clojure.lang.ArraySeq.ArraySeq_char)a_seq1).array);
   {
    long i5 = clojure.lang.RT.longCast((int)((clojure.lang.ArraySeq.ArraySeq_char)a_seq1).index());
    Object val6 = val3;
    while(true) {
     if (clojure.lang.Numbers.lt((long)i5, (long)clojure.lang.RT.alength((char[])((char[])arr4)))) {
      {
       Object ret7 = ((IFn)f2).invoke(val6, Character.valueOf(clojure.lang.RT.aget((char[])((char[])arr4), (int)clojure.lang.RT.intCast((long)i5))));
