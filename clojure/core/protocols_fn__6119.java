...
public final class protocols_fn__6119 extends clojure.lang.AFunction {
 ...
 public protocols_fn__6119() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object a_seq1, java.lang.Object f2, java.lang.Object val3) {
  {
   Object arr4 = ((long[])((clojure.lang.ArraySeq.ArraySeq_long)a_seq1).array);
   {
    long i5 = clojure.lang.RT.longCast((int)((clojure.lang.ArraySeq.ArraySeq_long)a_seq1).index());
    Object val6 = val3;
    while(true) {
     if (clojure.lang.Numbers.lt((long)i5, (long)clojure.lang.RT.alength((long[])((long[])arr4)))) {
      {
       Object ret7 = ((IFn)f2).invoke(val6, Numbers.num(clojure.lang.RT.aget((long[])((long[])arr4), (int)clojure.lang.RT.intCast((long)i5))));
