...
public final class protocols_fn__6117 extends clojure.lang.AFunction {
 ...
 public protocols_fn__6117() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object a_seq1, java.lang.Object f2, java.lang.Object val3) {
  {
   Object arr4 = ((float[])((clojure.lang.ArraySeq.ArraySeq_float)a_seq1).array);
   {
    long i5 = clojure.lang.RT.longCast((int)((clojure.lang.ArraySeq.ArraySeq_float)a_seq1).index());
    Object val6 = val3;
    while(true) {
     if (clojure.lang.Numbers.lt((long)i5, (long)clojure.lang.RT.alength((float[])((float[])arr4)))) {
      {
       Object ret7 = ((IFn)f2).invoke(val6, Float.valueOf(clojure.lang.RT.aget((float[])((float[])arr4), (int)clojure.lang.RT.intCast((long)i5))));
