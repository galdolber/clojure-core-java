...
public final class protocols_fn__6115 extends clojure.lang.AFunction {
 ...
 public protocols_fn__6115() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object a_seq1, java.lang.Object f2, java.lang.Object val3) {
  {
   Object arr4 = ((double[])((clojure.lang.ArraySeq.ArraySeq_double)a_seq1).array);
   {
    long i5 = clojure.lang.RT.longCast((int)((clojure.lang.ArraySeq.ArraySeq_double)a_seq1).index());
    Object val6 = val3;
    while(true) {
     if (clojure.lang.Numbers.lt((long)i5, (long)clojure.lang.RT.alength((double[])((double[])arr4)))) {
      {
       Object ret7 = ((IFn)f2).invoke(val6, Double.valueOf(clojure.lang.RT.aget((double[])((double[])arr4), (int)clojure.lang.RT.intCast((long)i5))));
