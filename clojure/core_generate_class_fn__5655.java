...
public final class core_generate_class_fn__5655 extends clojure.lang.AFunction {
 ...
 Object totype36;
 Object meth143;
 public core_generate_class_fn__5655(final Object super_type40, final Object totype36, final Object meth143) {
  super();
  this.super_type40 = super_type40;
  this.totype36 = totype36;
  this.meth143 = meth143;
 }
 public java.lang.Object invoke(java.lang.Object gen1, java.lang.Object m2) {
  ...
  {
   Object pclasses3 = ((IFn)const__0.getRawRoot()).invoke(const__1.getRawRoot(), ((java.lang.Class[])((java.lang.reflect.Method)this.meth143).getParameterTypes()));
   Object rclass4 = ((IFn)const__1.getRawRoot()).invoke(((java.lang.Class)((java.lang.reflect.Method)this.meth143).getReturnType()));
   ...
   clojure.lang.Compiler.emitSource((java.lang.String)((java.lang.String)((IFn)const__3.getRawRoot()).invoke(__r3562, "super.", ((java.lang.String)((clojure.asm.commons.Method)m2).getName()), "(", ((IFn)const__4.getRawRoot()).invoke(const__3.getRawRoot(), ((IFn)const__5.getRawRoot()).invoke(", ", ((IFn)const__0.getRawRoot()).invoke(new clojure.core_generate_class_fn__5655_fn__5656(), ((IFn)const__6.getRawRoot()).invoke(Integer.valueOf(clojure.lang.RT.count(((java.lang.Object)pclasses3))))))), ");")));
   return null;
  }
 }
}
