...
public final class pprint_fn__7437 extends clojure.lang.AFunction {
 ...
 static {
  const__0 = (clojure.lang.Var)RT.var("clojure.pprint", "write-token");
  ...
  const__5 = (java.lang.Object)103;
  const__6 = (clojure.lang.Keyword)Keyword.intern(null, "private");
  const__7 = (clojure.lang.IPersistentMap)RT.map(Keyword.intern(null, "column"), 1, Keyword.intern(null, "private"), Boolean.TRUE, Keyword.intern(null, "line"), 103, Keyword.intern(null, "file"), "clojure/pprint/pretty_writer.clj");
  ...
  const__11 = (clojure.lang.IPersistentMap)RT.map(Keyword.intern(null, "column"), 1, Keyword.intern(null, "private"), Boolean.TRUE, Keyword.intern(null, "line"), 103, Keyword.intern(null, "file"), "clojure/pprint/pretty_writer.clj");
 ...
 public java.lang.Object invoke() {
  {
   ...
   if (and__3966__auto__2) {
    __r4860 = (((IFn)const__10.getRawRoot()).invoke(v__4105__auto__1) instanceof clojure.lang.MultiFn);
   } else {
    __r4860 = and__3966__auto__2;
   }
   if ((java.lang.Boolean)__r4860) {
    return null;
   } else {
    const__0.setMeta((IPersistentMap)const__11);
    const__0.bindRoot(new clojure.lang.MultiFn((java.lang.String)((java.lang.String)"write-token"), (clojure.lang.IFn)((clojure.lang.IFn)new clojure.pprint_fn__7437_fn__7438()), ((java.lang.Object)const__12), (clojure.lang.IRef)((clojure.lang.IRef)const__13)));
    return const__0;
   }
  }
 }
