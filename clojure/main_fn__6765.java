...
public final class main_fn__6765 extends clojure.lang.AFunction {
 ...
 static {
  ...
  const__4 = (clojure.lang.Symbol)((clojure.lang.IObj)Symbol.intern(null, "clojure.main")).withMeta((IPersistentMap)RT.map(Keyword.intern(null, "author"), "Stephen C. Gilardi and Rich Hickey", Keyword.intern(null, "doc"), "Top-level main function for Clojure REPL and scripts."));
 }
 public main_fn__6765() {
  super();
 }
