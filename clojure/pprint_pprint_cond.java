...
public final class pprint_pprint_cond extends clojure.lang.AFunction {
 ...
 public pprint_pprint_cond() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object alis1) {
  try {
   Object __r6152 = ((IFn)const__0).invoke();
   if (__r6152 != null && !(__r6152 == Boolean.FALSE)) {
    ...
    ((IFn)new clojure.pprint_pprint_cond_fn__8429(alis1)).invoke();
   }
   return null;
