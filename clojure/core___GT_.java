...
public final class core___GT_ extends clojure.lang.RestFn {
 ...
 public java.lang.Object doInvoke(java.lang.Object _AMPERSAND_form1, java.lang.Object _AMPERSAND_env2, java.lang.Object x3, java.lang.Object forms4) {
  {
   ...
   while(true) {
    Object __r2391 = forms6;
    if (__r2391 != null && !(__r2391 == Boolean.FALSE)) {
     {
      Object form7 = ((IFn)const__0.getRawRoot()).invoke(forms6);
      Object __r2392;
      Object __r2393 = ((IFn)const__1.getRawRoot()).invoke(form7);
      if (__r2393 != null && !(__r2393 == Boolean.FALSE)) {
       __r2392 = ((IFn)const__2.getRawRoot()).invoke(((IFn)const__3.getRawRoot()).invoke(((IFn)const__4.getRawRoot()).invoke(((IFn)const__5.getRawRoot()).invoke(((IFn)const__0.getRawRoot()).invoke(form7)), ((IFn)const__5.getRawRoot()).invoke(x5), ((IFn)const__6.getRawRoot()).invoke(form7))), ((IFn)const__7.getRawRoot()).invoke(form7));
      } else {
       __r2392 = ((IFn)const__5.getRawRoot()).invoke(form7, x5);
      }
      Object threaded8 = __r2392;
