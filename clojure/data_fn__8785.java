...
public final class data_fn__8785 extends clojure.lang.AFunction {
 ...
 static {
  ...
  const__4 = (clojure.lang.Symbol)((clojure.lang.IObj)Symbol.intern(null, "clojure.data")).withMeta((IPersistentMap)RT.map(Keyword.intern(null, "doc"), "Non-core data functions.", Keyword.intern(null, "author"), "Stuart Halloway"));
 }
 public data_fn__8785() {
  super();
 }
