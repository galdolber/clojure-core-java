...
public final class core_fn__5444 extends clojure.lang.AFunction {
 ...
 public core_fn__5444() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object m1, java.lang.Object w2) {
  Object __r3460 = const__0.get();
  if (__r3460 != null && !(__r3460 == Boolean.FALSE)) {
   ((IFn)const__1.getRawRoot()).invoke(m1, w2);
   return ((IFn)const__2.getRawRoot()).invoke(m1, const__3.getRawRoot(), w2);
  } else {
   return ((IFn)const__4.getRawRoot()).invoke(m1, w2);
  }
 }
}
