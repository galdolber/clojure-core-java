...
public final class core_fn__4957 extends clojure.lang.AFunction {
 ...
 static {
  const__0 = (clojure.lang.Var)RT.var("clojure.core", "*pending-paths*");
  ...
  const__5 = (java.lang.Object)5341;
  ...
  const__9 = (clojure.lang.IPersistentMap)RT.map(Keyword.intern(null, "dynamic"), Boolean.TRUE, Keyword.intern(null, "column"), 1, Keyword.intern(null, "private"), Boolean.TRUE, Keyword.intern(null, "doc"), "A stack of paths currently being loaded by this thread", Keyword.intern(null, "line"), 5341, Keyword.intern(null, "file"), "clojure/core.clj");
  const__10 = (java.lang.Object)5341;
  const__11 = (clojure.lang.IPersistentMap)RT.map(Keyword.intern(null, "dynamic"), Boolean.TRUE, Keyword.intern(null, "column"), 1, Keyword.intern(null, "private"), Boolean.TRUE, Keyword.intern(null, "doc"), "A stack of paths currently being loaded by this thread", Keyword.intern(null, "line"), 5341, Keyword.intern(null, "file"), "clojure/core.clj");
 }
 public core_fn__4957() {
  super();
 }
 public java.lang.Object invoke() {
  {
   ...
   if (((clojure.lang.Var)v__4952__auto__1).hasRoot()) {
    ...
    const__0.bindRoot(clojure.lang.PersistentList.EMPTY);
    return const__0;
   }
  }
 }
