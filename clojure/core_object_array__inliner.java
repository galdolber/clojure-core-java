...
public final class core_object_array__inliner extends clojure.lang.AFunction {
 ...
 static {
  ...
  const__5 = (clojure.lang.Symbol)Symbol.intern("clojure.core", "object_array");
 }
 public core_object_array__inliner() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object arg1) {
  return ((IFn)const__0.getRawRoot()).invoke(((IFn)const__1.getRawRoot()).invoke(((IFn)const__2.getRawRoot()).invoke(const__3), ((IFn)const__2.getRawRoot()).invoke(const__4), ((IFn)const__2.getRawRoot()).invoke(const__5), ((IFn)const__2.getRawRoot()).invoke(arg1)));
 }
}
