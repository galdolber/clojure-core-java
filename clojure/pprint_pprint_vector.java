...
public final class pprint_pprint_vector extends clojure.lang.AFunction {
 ...
 public pprint_pprint_vector() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object avec1) {
  try {
   Object __r5922 = ((IFn)const__0).invoke();
   if (__r5922 != null && !(__r5922 == Boolean.FALSE)) {
    ...
    ((IFn)new clojure.pprint_pprint_vector_fn__8230(avec1)).invoke();
   }
   return null;
