...
public final class pprint_pprint_simple_code_list extends clojure.lang.AFunction {
 ...
 public pprint_pprint_simple_code_list() {
  super();
 }
 public java.lang.Object invoke(java.lang.Object alis1) {
  try {
   Object __r6188 = ((IFn)const__0).invoke();
   if (__r6188 != null && !(__r6188 == Boolean.FALSE)) {
    ...
    ((IFn)new clojure.pprint_pprint_simple_code_list_fn__8458(alis1)).invoke();
   }
   return null;
